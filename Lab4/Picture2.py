...
def hedgehog(x, y):
    ...
    pg.draw.ellipse(sc, (0, 0, 0), (sc_width * x + hedgehog_width * 0.9, sc_height * y + hedgehog_height * 0.4, 50, 30),
                    1)
    ...
    pg.draw.ellipse(sc, (255, 255, 255),
    ...
    for i in range(30):
        ...
        t = [sc_width * x + a + x0, sc_height * y + b + y0]
        B = [sc_width * x + a + x0 + 20 * np.cos(k), sc_height * y + b + y0 - 20 * np.sin(k)]
        C = [sc_width * x + a + x0 + 5 - 90 * np.sin(k), sc_height * y + b + y0 - 90 * np.cos(k)]
        pg.draw.polygon(sc, (30, 30, 30), [t, B, C], )
        pg.draw.polygon(sc, (0, 0, 0), [t, B, C], 1)
